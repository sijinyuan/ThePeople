package bw.com.likqlibrary.netutils;
...
public class Retrofit2Helper {
    ...
    /**
     *  getApi直接传入baseUrl和class
     * @param clas
     * @param <T>
     * @return
     */
    public static <T> T getApi(String url,Class<T> clas){
        return Retrofit2Helper.getInstance().getRetrofit(url).create(clas);
    }
}